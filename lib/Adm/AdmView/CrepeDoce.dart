...
class CrepeDoce extends StatefulWidget {
  @override
  _CrepeDoceState createState() => _CrepeDoceState();
}


class _CrepeDoceState extends State<CrepeDoce> {
  ...
  Stream<QuerySnapshot> _adicionarListenerCrepeSalgado(){
    final stream = Firestore.instance.collection("Produto").document("Crepe Doce").collection("Crepe Doce").snapshots();
